...
export default function Home() {
  return (
    ...
    >
      ...
      <section
        className="w-full px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8 
      ...
      >
        ...
        <header className="space-y-6">
          <h1
            ...
            bg-gradient-to-r from-gray-900 via-gray-800 to-gray-600 bg-clip-text
            text-transparent"
          >
            AI Agent Assistant
          </h1>
          <p className="max-w-[600px] text-lgtext-gray-600 md:text-xl/relaxed xl:text-2xl/relaxed">
        ...
        <SignedOut>
          ...
          >
            <button
              className="group relative inline-flex items-center justify-center px-8 py-3.5 text-base font-medium hover: to-gray-700 text-white bg-gradient-to-r from-gray-900to-gray-800 rounded-full hover:from-gray-800 transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
            >
              Sign Up
              <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover: translate-x-0.5" />
              <div
